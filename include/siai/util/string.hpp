...
namespace Util
{
    namespace String
    {
        ...
        std::string getOptionName(const std::string& line, char separator='=');
        ...
        int getOptValueAsInt(const std::string& line, char separator='=');
        std::string getOptValueAsStr(const std::string& line, char separator='=');
