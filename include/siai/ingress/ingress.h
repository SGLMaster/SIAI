...
namespace Forms
{
	...
	class IngressFrame : public wxFrame
	{
		...
		public:
			...
			IngressFrame( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Asistente de Ingreso SIAI"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 500,600 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
